...
class ShapePredictNode :
    def __init__(self, model):
        ...
        self.pubmask = rospy.Publisher('/semantic/mask', Image,queue_size=1)
        self.pubpose = rospy.Publisher('/semantic/camera', PoseStamped ,queue_size=1)
     
        # Subscribers
        rgb_sub = message_filters.Subscriber('/orb_slam3_ros/rgb', Image)
        depth_sub = message_filters.Subscriber('/orb_slam3_ros/depth', Image)
        pose_sub = message_filters.Subscriber('/orb_slam3_ros/camera', PoseStamped)
        ts = message_filters.TimeSynchronizer([rgb_sub,depth_sub, pose_sub], 1)
    ...
    def callback_getimage(self, rgb_sub,depth_sub,pose):
...
if __name__ == '__main__':
    ...
    model.load_state_dict(torch.load('/home/isl/catkin_ws/src/read_image_bag/weights/mobile_deeplap_sweetpp.pth', 
